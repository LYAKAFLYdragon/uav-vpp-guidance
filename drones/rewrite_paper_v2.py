...
# 17. DISCUSSION TASK-CONDITIONED
old_disc_tc = (
...
# REFERENCES CLEANUP
bib_replacements = [
    ("Autonomous Decision-Making for Dogfights Based on a Tactical Pursuit Point Approach", "Autonomous Decision-Making for Close-Range Encounter Using a Tactical Pursuit Point Approach"),
    ("Mastering Air Combat Game with Deep Reinforcement Learning", "Mastering Close-Range Encounter Games with Deep Reinforcement Learning"),
    ("Maneuver Decision of UAV in Short-Range Air Combat Based on Deep Reinforcement Learning", "Maneuver Decision of UAV in Short-Range Close Encounter Based on Deep Reinforcement Learning"),
    ("Interpretable DRL-Based Maneuver Decision of UCAV Dogfight", "Interpretable DRL-Based Maneuver Decision of UCAV Close Encounter"),
    ("Air Combat Maneuver Decision Method Based on A3C Deep Reinforcement Learning", "Close-Range Maneuver Decision Method Based on A3C Deep Reinforcement Learning"),
]
...
print("\n--- Verification ---")
checks = [
    "pilot-scale", "does not fully isolate finetune effects", "showed the most favourable observed trade-off",
    "does not constitute a held-out generalisation estimate", "reduces architectural confounds", "three auditable carriers",
    "warm-started from the same baseline checkpoint", "expert controller", "end-to-end learned controller",
    "AoA $60^\\circ$", "Termination semantics", "Statistical stance", "clearest pilot-scale support",
    "auditable interface-layer change", "methodological relevance for auditability assessment",
    "simulation-only and non-operational", "does not constitute a certification claim",
    "No isolated semantics-only control", "\\appendix", "Semantics-Only Control", "Training Metadata",
    "Counterpart Controller Specifications", "Seed-Level Raw Values", "Coefficient Summary",
    "Termination Count Table", "Terminology Mapping",
]
for c in checks:
