...
- [ ] **当前唯一允许动作：完成 P2-B2 的独立 pre-merge/re-entry physical-reachability preflight；R5 capability card 的 phase 仅为 post_merge，不能代替此 gate。不得直接训练、调参或启动 formal held-out。**
