...
- [manifest builder](E:/uav-vpp-guidance-five-state-heldout-envelope-v1/scripts/build_thesis_neutral_postmerge_reentry_recovery_v3_feasibility_manifest.py) 已生成 [manifest48](E:/uav-vpp-guidance-five-state-heldout-envelope-v1/config/experiment/manifests/thesis_neutral_postmerge_reentry_recovery_v3_runtime_feasibility48.yaml)，payload SHA-256 为 `dfaca79bdafa16a72b01a2c9af8b43987e8e7b3ef1c73b20f3d27035a2ae5054`。
