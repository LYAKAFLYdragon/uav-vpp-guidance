...
REM
REM Run-time: ~15-20 minutes (36 head-on + 4 crossing scenarios)
REM ============================================================================
...
SET "RUN_ID=oracle_vs_secondary_clamp_fresh_geometry_formal_heldout_expert_20260701"
...
::     Use junction (directory symlink) to avoid copying large files.
