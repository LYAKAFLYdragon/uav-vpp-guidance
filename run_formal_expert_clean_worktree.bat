...
REM ============================================================================
REM Clean-Worktree Formal Runner: Expert Stage
REM ============================================================================
REM Purpose: Run formal held-out evaluation from a clean git worktree at the
REM frozen SHA. This keeps paper_safe=true independent of the main repo state.
REM
REM External dependencies not tracked by git:
REM   - envs/JSBSim
REM   - outputs/experiments
REM   - outputs/trajectory_prediction
REM   - outputs/diagnostics/...checkpoint_snapshots
REM ============================================================================
...
set "RUN_ID=oracle_vs_commander_post_merge_recovery_formal_heldout_expert_20260703"
set "OPPONENT_STAGE=expert"
...
echo.
echo ============================================================================
echo Clean-Worktree Formal Runner: Expert Stage
echo ============================================================================
...
echo.
echo ============================================================================
echo Clean-Worktree Formal Runner: Expert Stage Complete
echo ============================================================================
if %RUN_EXIT% EQU 0 (
    echo Status: SUCCESS
