...
$config = "config/experiment/train_prediction_vpp_ppo_jsbsim_compare_long_lh1p0_reset075_no_mode_switch_longscale00_combat_finetune.yaml"
...
Write-Host "Running reset075 no-mode-switch longscale00 combat-only finetune..."
& $PythonExe @args
