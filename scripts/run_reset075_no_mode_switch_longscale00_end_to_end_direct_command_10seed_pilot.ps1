...
$config = "config/experiment/jsbsim_hrl_reset075_no_mode_switch_longscale00_end_to_end_direct_command_best.yaml"

if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "reset075_no_mode_switch_longscale00_end_to_end_direct_command_best_${OpponentStage}_10seed_20260630"
}
...
Write-Host "Running end-to-end direct-command 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
