...
$config = "config/experiment/jsbsim_hrl_reset075_no_mode_switch_longscale00_geometry_family_main_table.yaml"

if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "reset075_no_mode_switch_longscale00_geometry_family_main_table_${OpponentStage}_10seed_20260630"
}
...
Write-Host "Running unified geometry-family 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
