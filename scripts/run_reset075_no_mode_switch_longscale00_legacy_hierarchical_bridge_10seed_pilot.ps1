...
if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "reset075_no_mode_switch_longscale00_legacy_hierarchical_bridge_${OpponentStage}_10seed_20260630"
}
...
Write-Host "Running legacy hierarchical bridge 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
