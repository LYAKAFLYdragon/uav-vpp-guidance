...
$config = "config/experiment/jsbsim_hrl_reset075_no_mode_switch_longscale00_no_vpp_combat_best.yaml"

if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "reset075_no_mode_switch_longscale00_no_vpp_combat_best_${OpponentStage}_10seed_20260630"
}
...
Write-Host "Running no-VPP combat 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
