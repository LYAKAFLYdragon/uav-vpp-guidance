...
$expertRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_offensive_position_encounter_rearquarter300_geomgate_aa170_release1_pilot_expert"
$e2eRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_offensive_position_encounter_rearquarter300_geomgate_aa170_release1_pilot_end_to_end"
...
Write-Host "Running post-merge anchor-mode offensive-position pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running post-merge anchor-mode offensive-position pilot against end_to_end..."
& $PythonExe @endToEndArgs

$analysisScript = Join-Path $repoRoot "scripts\analyze_postmerge_anchor_mode_pilot.py"
$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\postmerge_anchor_mode_offensive_position_pilot"

Write-Host "Building post-merge anchor-mode pilot comparison report..."
& $PythonExe $analysisScript `
    --baseline-expert-run-dir "E:\uav-vpp-guidance\outputs\jsbsim_hrl_comparison\reset075_no_mode_switch_longscale00_postmerge_offblend025_encounter_rearquarter300_geomgate_aa170_release1_directtrack2000_pilot_expert" `
    --baseline-end-to-end-run-dir "E:\uav-vpp-guidance\outputs\jsbsim_hrl_comparison\reset075_no_mode_switch_longscale00_postmerge_offblend025_encounter_rearquarter300_geomgate_aa170_release1_directtrack2000_pilot_end_to_end" `
