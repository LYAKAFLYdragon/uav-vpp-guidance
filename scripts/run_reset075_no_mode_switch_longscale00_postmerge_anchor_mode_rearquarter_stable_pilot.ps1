...
$expertRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_rearquarterstable300_release1_pilot_expert"
$e2eRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_rearquarterstable300_release1_pilot_end_to_end"
...
Write-Host "Running rear-quarter stable anchor-mode pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running rear-quarter stable anchor-mode pilot against end_to_end..."
& $PythonExe @endToEndArgs

$analysisScript = Join-Path $repoRoot "scripts\analyze_postmerge_anchor_mode_pilot.py"
$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\postmerge_anchor_mode_rearquarter_stable_pilot"

Write-Host "Building rear-quarter stable anchor-mode pilot comparison report..."
