...
$expertRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_softblend025_encounter_rearquarter300_geomgate_aa170_release1_pilot_expert"
$e2eRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_softblend025_encounter_rearquarter300_geomgate_aa170_release1_pilot_end_to_end"
...
Write-Host "Running post-merge anchor-mode soft-blend pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running post-merge anchor-mode soft-blend pilot against end_to_end..."
& $PythonExe @endToEndArgs

$analysisScript = Join-Path $repoRoot "scripts\analyze_postmerge_anchor_mode_pilot.py"
$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\postmerge_anchor_mode_softblend_pilot"

Write-Host "Building post-merge anchor-mode soft-blend pilot comparison report..."
