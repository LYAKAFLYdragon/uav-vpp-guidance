...
$expertRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_targetvelrear_laterallatch_pilot_expert"
$e2eRunId = "reset075_no_mode_switch_longscale00_postmerge_anchormode_targetvelrear_laterallatch_pilot_end_to_end"
...
Write-Host "Running target-velocity longitudinal + lateral-latch pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running target-velocity longitudinal + lateral-latch pilot against end_to_end..."
& $PythonExe @endToEndArgs

$analysisScript = Join-Path $repoRoot "scripts\analyze_postmerge_anchor_mode_pilot.py"
$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\postmerge_anchor_mode_targetvel_longitudinal_lateral_latch_pilot"

Write-Host "Building target-velocity longitudinal + lateral-latch pilot comparison report..."
& $PythonExe $analysisScript `
    --baseline-expert-run-dir "E:\uav-vpp-guidance\outputs\jsbsim_hrl_comparison\reset075_no_mode_switch_longscale00_postmerge_anchormode_takeover_encounter_rearquarter300_geomgate_aa170_release1_laterallatch_pilot_expert" `
    --baseline-end-to-end-run-dir "E:\uav-vpp-guidance\outputs\jsbsim_hrl_comparison\reset075_no_mode_switch_longscale00_postmerge_anchormode_takeover_encounter_rearquarter300_geomgate_aa170_release1_laterallatch_pilot_end_to_end" `
