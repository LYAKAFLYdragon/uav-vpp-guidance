...
$expertArgs = $commonArgs + @(
    "--run-id",
    "reset075_no_mode_switch_longscale00_postmerge_offblend025_encounter_rearquarter300_geomgate_aa170_release1_directtrack2000_pilot_expert",
    "--opponent-stage", "expert"
)

$endToEndArgs = $commonArgs + @(
    "--run-id",
    "reset075_no_mode_switch_longscale00_postmerge_offblend025_encounter_rearquarter300_geomgate_aa170_release1_directtrack2000_pilot_end_to_end",
    "--opponent-stage", "end_to_end"
)

Write-Host "Running directtrack2000 rear-quarter pilot against expert..."
& python @expertArgs

Write-Host "Running directtrack2000 rear-quarter pilot against end_to_end..."
& python @endToEndArgs
