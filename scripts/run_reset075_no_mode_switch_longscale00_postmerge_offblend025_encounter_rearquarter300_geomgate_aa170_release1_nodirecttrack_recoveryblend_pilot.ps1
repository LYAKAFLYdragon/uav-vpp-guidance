...
$runLabel = "recoveryblend_release"
$candidateRunTag = "reset075_no_mode_switch_longscale00_postmerge_offblend025_encounter_rearquarter300_geomgate_aa170_release1_nodirecttrack_recoveryblend_pilot"
...
Write-Host "Running recovery-blend rear-quarter pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running recovery-blend rear-quarter pilot against end_to_end..."
& $PythonExe @endToEndArgs

$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\rearquarter_recoveryblend_pilot"
...
Write-Host "Building recovery-blend rear-quarter pilot comparison report..."
