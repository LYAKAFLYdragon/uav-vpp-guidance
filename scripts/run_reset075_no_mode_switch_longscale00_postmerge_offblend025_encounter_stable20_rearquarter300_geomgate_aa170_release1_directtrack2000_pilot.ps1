...
$runTag = "reset075_no_mode_switch_longscale00_postmerge_offblend025_encounterstable20_rearquarter300_geomgate_aa170_release1_directtrack2000_pilot"
...
Write-Host "Running directtrack2000 encounter-stable-20 pilot against expert..."
& $PythonExe @expertArgs

Write-Host "Running directtrack2000 encounter-stable-20 pilot against end_to_end..."
...
$analysisOutputDir = "E:\uav-vpp-guidance\outputs\diagnostics\directtrack2000_encounter_stable20_pilot"
...
$analysisArgs = @(
    ...
    "--run", "stable20=$variantExpert",
    "--run", "stable20=$variantEndToEnd"
)

Write-Host "Building directtrack2000 encounter-stable-20 pilot comparison report..."
