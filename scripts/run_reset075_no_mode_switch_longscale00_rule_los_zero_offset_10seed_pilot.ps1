...
$config = "config/experiment/jsbsim_hrl_reset075_no_mode_switch_longscale00_rule_los_zero_offset.yaml"

if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "reset075_no_mode_switch_longscale00_rule_los_zero_offset_${OpponentStage}_10seed_20260630"
}
...
Write-Host "Running LOS zero-offset 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
