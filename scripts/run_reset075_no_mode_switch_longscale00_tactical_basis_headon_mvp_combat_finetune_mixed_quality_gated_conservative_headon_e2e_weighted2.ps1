...
Write-Host "Running reset075 no-mode-switch longscale00 tactical-basis mixed quality-gated conservative-head_on end-to-end-weighted2 combat-only finetune..."
& $PythonExe @args
