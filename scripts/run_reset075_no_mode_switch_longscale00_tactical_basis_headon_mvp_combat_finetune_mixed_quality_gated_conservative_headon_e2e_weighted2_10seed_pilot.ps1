...
if ([string]::IsNullOrWhiteSpace($RunId)) {
    $RunId = "tactical_basis_headon_mvp_combat_finetune_mixed_quality_gated_conservative_headon_e2e_weighted2_best_${OpponentStage}_10seed_20260629"
}
...
Write-Host "Running e2e-weighted2 10-seed pilot for opponent stage '$OpponentStage'..."
& $PythonExe @args
